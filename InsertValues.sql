...
-- Вставляем тиражи
INSERT INTO circulation("BookCipher", "Publisher", "ReceiptDate", "PurchasePrice", "SellPrice", "ReceivedCopies") VALUES
('s{291$#OWe', 'Питер', '20190101', 2323, 2600, 100),
('s{291$#OWe', 'Питер', '20190101', 1987, 2500, 200),
('}*1GlBtDjt', 'Техносфера', '20090628', 745, 1000, 300),
('1yP|j9@b?j', 'Байкал', '19670101', 1000, 1500, 200000),
('VSMtdpWI6*', 'АСТ', '20170516', 500, 600, 3000),
('s{291$#OWe', 'ДМК Пресс', '20191205', 1000, 1200, 500),
('rlT1AuH6u%', 'АСТ', '18690320', 200, 250, 4000),
('OM6~B~L1VT', 'АСТ', '20220806', 200, 250, 20000),
('yc}tFCoN}f', 'АСТ', '20220504', 400, 700, 1500),
('#RJ7U6|r7W', 'АСТ', '20210604', 300, 550, 30000),
('FZJLFLK?6o', 'Питер', '20220316', 900, 1150, 3000),
('9hm5$QT#5m', 'АСТ', '20210417', 1100, 1150, 7000),
('4HgP630G#|', 'Питер', '20210713', 1600, 1700, 3000),
('3L#i{|wX$L', 'Эксмо', '20221013', 600, 800, 400),
('dOcsyco0dj', 'BHV', '20211230', 900, 1000, 1000),
('zvPDM*kxC}', 'АСТ', '20210101', 300, 600, 4500);

-- Вставляем продажи книг
INSERT INTO booksale("SalesmanID", "CirculationID", "CountCopies") VALUES
(4, 8, 5),
(11, 3, 3),
(2, 10, 1),
(5, 3, 8),
